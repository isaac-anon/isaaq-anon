...
from aux_methods import get_data_tf, process_data_tf, validation_tf, get_upper_bound, ensembler
...
def main(argv):
    ...
    for model, retrieval_solver in zip(models, retrieval_solvers):
        ...
        train_dataloader = process_data_tf(raw_data_train, batch_size, "val")
        ...
        test_dataloader = process_data_tf(raw_data_test, batch_size, "test")
