...
from aux_methods import get_data_tf, process_data_tf, training_tf
...
def main(argv):
    ...
    train_dataloader = process_data_tf(raw_data_train, batch_size, "train")
    val_dataloader = process_data_tf(raw_data_val, batch_size, "val")
